...
| `completion_scorecard` | `artifact` | `results/run/nodes/006-completion-gate-75e1c6516166/executions/i001-a001-exec-306cb45daffd89af/artifacts/scorecard.json` | Artifact "completion_scorecard" produced by node "export_readiness__managed__pattern_deep_work__completion_gate". | This task needs the producer artifact as evidence for its contract. |
